...
import table from '../../assets/images/tablesetting2.jpg'
import table1 from '../../assets/images/tablesetting.jpg'
import './index.css'
      ...
      <div className="w3-content">
        ...
        <div className="w3-row w3-padding-64" id="about">
          <div className="w3-col m6 w3-padding-large w3-hide-small">
            <img
              src={table}
              className="w3-round w3-image w3-opacity-min image-custom"
              alt="Table Setting"
        ...
        <div className="w3-row w3-padding-64" id="menu">
          ...
          <div className="w3-col l6 w3-padding-large">
            <img
              src={table1}
              className="w3-round w3-image w3-opacity-min table1-image"
              alt="Menu"
            />
          </div>
        </div>
